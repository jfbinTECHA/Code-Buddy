...
const typeorm_store_service_1 = require("./typeorm-store.service");
const entities_1 = require("./entities");
const constants_1 = require("./constants");
describe('TypeOrmStore', () => {
    let service;
    let clientRepository;
    let authCodeRepository;
    ...
    beforeEach(async () => {
        ...
        const module = await testing_1.Test.createTestingModule({
            providers: [
                typeorm_store_service_1.TypeOrmStore,
                {
                    provide: (0, typeorm_1.getRepositoryToken)(entities_1.OAuthClientEntity, constants_1.OAUTH_TYPEORM_CONNECTION_NAME),
                    useValue: mockClientRepository,
                },
                {
                    provide: (0, typeorm_1.getRepositoryToken)(entities_1.AuthorizationCodeEntity, constants_1.OAUTH_TYPEORM_CONNECTION_NAME),
                    useValue: mockAuthCodeRepository,
                },
                {
                    provide: (0, typeorm_1.getRepositoryToken)(entities_1.OAuthSessionEntity, constants_1.OAUTH_TYPEORM_CONNECTION_NAME),
                    useValue: mockSessionRepository,
                },
                {
                    provide: (0, typeorm_1.getRepositoryToken)(entities_1.OAuthUserProfileEntity, constants_1.OAUTH_TYPEORM_CONNECTION_NAME),
                    useValue: mockUserProfileRepository,
                },
            ],
        }).compile();
        service = module.get(typeorm_store_service_1.TypeOrmStore);
        clientRepository = module.get((0, typeorm_1.getRepositoryToken)(entities_1.OAuthClientEntity, constants_1.OAUTH_TYPEORM_CONNECTION_NAME));
        authCodeRepository = module.get((0, typeorm_1.getRepositoryToken)(entities_1.AuthorizationCodeEntity, constants_1.OAUTH_TYPEORM_CONNECTION_NAME));
        sessionRepository = module.get((0, typeorm_1.getRepositoryToken)(entities_1.OAuthSessionEntity, constants_1.OAUTH_TYPEORM_CONNECTION_NAME));
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
    ...
    describe('Client Management', () => {
        ...
        describe('storeClient', () => {
            ...
            it('should handle database errors', async () => {
                ...
                await expect(service.storeClient(mockClient)).rejects.toThrow('Database error');
            });
        });
        describe('getClient', () => {
            ...
            it('should handle database errors', async () => {
                ...
                await expect(service.getClient('test-client-id')).rejects.toThrow('Database error');
            });
        });
        describe('findClient', () => {
            ...
            it('should handle database errors', async () => {
                const error = new Error('Database error');
                clientRepository.findOne.mockRejectedValue(error);
                await expect(service.findClient('Test Client')).rejects.toThrow('Database error');
            });
        });
    });
    describe('Authorization Code Management', () => {
        ...
        describe('storeAuthCode', () => {
            it('should store an authorization code', async () => {
                authCodeRepository.save.mockResolvedValue(mockAuthCode);
            ...
            it('should handle database errors', async () => {
                ...
                await expect(service.storeAuthCode(mockAuthCode)).rejects.toThrow('Database error');
            });
        });
        describe('getAuthCode', () => {
            it('should return authorization code when found and not expired', async () => {
                authCodeRepository.findOne.mockResolvedValue(mockAuthCode);
            ...
            it('should return undefined and delete expired authorization code', async () => {
                authCodeRepository.findOne.mockResolvedValue(expiredAuthCode);
            ...
            it('should handle database errors', async () => {
                ...
                await expect(service.getAuthCode('test-auth-code')).rejects.toThrow('Database error');
            });
        });
        describe('removeAuthCode', () => {
            ...
            it('should handle database errors', async () => {
                ...
                await expect(service.removeAuthCode('test-auth-code')).rejects.toThrow('Database error');
            });
        });
    });
    describe('OAuth Session Management', () => {
        ...
        describe('storeOAuthSession', () => {
            it('should store an OAuth session', async () => {
                ...
                sessionRepository.save.mockResolvedValue(expectedEntity);
            ...
            it('should handle database errors', async () => {
                ...
                await expect(service.storeOAuthSession('session-123', mockSession)).rejects.toThrow('Database error');
            });
        });
        describe('getOAuthSession', () => {
            ...
            it('should handle database errors', async () => {
                ...
                await expect(service.getOAuthSession('session-123')).rejects.toThrow('Database error');
            });
        });
        describe('removeOAuthSession', () => {
            ...
            it('should handle database errors', async () => {
                ...
                await expect(service.removeOAuthSession('session-123')).rejects.toThrow('Database error');
            });
        });
    });
});
//# sourceMappingURL=typeorm-store.service.spec.js.map